...
export class ShopEntity {
    ...
    static createFrom(source: any) {
        ...
        result.created_at = source["created_at"] ? Time.createFrom(source["created_at"]) : null;
        result.updated_at = source["updated_at"] ? Time.createFrom(source["updated_at"]) : null;
        result.location = source["location"] ? LatLng.createFrom(source["location"]) : null;
